...
const forgetPasswordLinkOwnerCollection = require("./forgetPasswordLinkOwnerModal");
...
ownerSchema.methods.generateJWTFromUser = function(){
...
ownerSchema.methods.getResetPasswordTokenFromOwner=async function(){
    ...
    // this.resetPasswordExpire =Date.now()+ parseInt(RESET_PASSWORD_EXPIRE)
     const expiresAt = Date.now() + 10 * 60 * 1000;
        ...
        await forgetPasswordLinkOwnerCollection.create({
            userId: this._id,
