...
const {getAllCity,getAllCinemaByCity,getSingleMovie,getShow,getMovieforcinema,getMoviesInCity,getMoviesInCinema,getLatestMovie,getUpCommingMovie}=require("../controllers/user/userWork");
